...
containing data to be store. Then the file is read and the data is parsed. The second option allows for the user to search for a key withing the avl tree. Third option allows the user to insert a new key into the tree. Fith option displays the height of the tree and the size of it.
